...
def generateControllerConfig(system: Emulator, playersControllers: ControllerPlayerMapping, metadata: Mapping[str, str], wheels: DeviceInfoMapping, rom: Path, guns: GunMapping) -> None:
...
def generateControllerConfig_emulatedwiimotes(system: Emulator, playersControllers: ControllerPlayerMapping, wheels: DeviceInfoMapping, rom: Path) -> None:
    wiiMapping = {
        'x':             'Buttons/2',
        'b':             'Buttons/A',
        'y':             'Buttons/1',
...
def generateControllerConfig_gamecube(system: Emulator, playersControllers: ControllerPlayerMapping, wheels: DeviceInfoMapping, rom: Path) -> None:
    gamecubeMapping = {
        'b':             'Buttons/B',
        'a':             'Buttons/A',
        'y':             'Buttons/Y',
...
def generateHotkeys(playersControllers: ControllerPlayerMapping) -> None:
...
def generateControllerConfig_any(system: Emulator, playersControllers: ControllerPlayerMapping, wheels: DeviceInfoMapping, filename: str, anyDefKey: str, anyMapping: Mapping[str, str], anyReverseAxes: Mapping[str, str], anyReplacements: Mapping[str, str] | None, extraOptions: Mapping[str, str] = {}) -> None:
    configFileName = DOLPHIN_CONFIG / filename
    f = codecs.open(str(configFileName), "w", encoding="utf_8_sig")
    nplayer = 1
    nsamepad = 0
