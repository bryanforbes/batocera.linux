...
class Fallout2Generator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        fout2Cfg.set("preferences", "game_difficulty", system.get_option_str("fout2_game_difficulty", "1"))
        fout2Cfg.set("preferences", "combat_difficulty", system.get_option_str("fout2_combat_difficulty", "1"))
        fout2Cfg.set("preferences", "violence_level", system.get_option_str("fout2_violence_level", "2"))
        fout2Cfg.set("preferences", "subtitles", system.get_option_str("fout2_subtitles", "0"))
        fout2Cfg.set("system", "language", system.get_option_str("fout2_language", "english"))
