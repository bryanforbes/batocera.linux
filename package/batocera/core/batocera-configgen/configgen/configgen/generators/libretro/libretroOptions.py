...
def _mgba_options(
    ...
    if system.name == 'sgb':
        ...
        _set(coreSettings, 'mgba_sgb_borders', 'OFF' if system.get_option('sgb_borders') == "OFF" else 'ON')
    else:
...
def _mesen_options(
    ...
    _set_from_system(coreSettings, 'mesen_fdsfastforwardload', system, 'mesen_fdsautoinsertdisk', default='disabled')
...
def _duckstation_options(
    ...
    if system.get_option_bool("gpu_software"):
        ...
        if gfxbackend := system.get_option("gfxbackend"):
            ...
            elif gfxbackend == "opengl" or gfxbackend == "glcore":
...
def _openlara_options(
    ...
    # Internal resolution
    _set_from_system(coreSettings, 'openlara_resolution', system, 'lara-resolution', default='1280x720')

    # Framerate
    _set_from_system(coreSettings, 'openlara_framerate', system, 'lara-framerate', default='60fps')
...
def _hatarib_options(
    ...
    # CPU Clock
    _set_from_system(coreSettings, 'hatarib_cpu_clock', system, 'hatarib_cpu', default='-1')
    # ST Memory Size
