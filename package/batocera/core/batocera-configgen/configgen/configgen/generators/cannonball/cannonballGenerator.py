...
class CannonballGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        ET.SubElement(video, "fps_counter").text = "1" if system.show_fps else "0"
        ET.SubElement(video, "widescreen").text = "1" if system.get_option("ratio") == "1" else "0"
        ET.SubElement(video, "hires").text = "1" if system.get_option("highResolution") == "1" else "0"
