...
class DolphinTriforceGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        dolphinTriforceSettings.set("Interface", "OnScreenDisplayMessages", str(not system.get_option_bool("triforce_osd_messages")))
        ...
        # Dual Core
        dolphinTriforceSettings.set("Core", "CPUThread", str(system.get_option_bool("triforce_dual_core")))

        # Gpu Sync
        dolphinTriforceSettings.set("Core", "SyncGPU", str(system.get_option_bool("triforce_gpu_sync")))
        ...
        dolphinTriforceGFXSettings.set("Settings", "AspectRatio", system.get_option_str("triforce_aspect_ratio", "0")) # set to zero, which is 'Auto' in Dolphin & Batocera

        # Show fps
        dolphinTriforceGFXSettings.set("Settings", "ShowFPS", str(system.show_fps))

        # HiResTextures
        if system.get_option_bool('triforce_hires_textures'):
        ...
        if system.get_option_bool('triforce_perf_hacks'):
        ...
        dolphinTriforceGFXSettings.set("Settings", "EFBScale", system.get_option_str("triforce_resolution", "2"))

        # VSync
        dolphinTriforceGFXSettings.set("Hardware", "VSync", str(system.get_option_bool('triforce_vsync', True)))

        # Anisotropic filtering
        anisotropy, filtering = system.get_option_str('triforce_filtering', '0/0').split('/')
        dolphinTriforceGFXSettings.set("Enhancements", "MaxAnisotropy", anisotropy)
        dolphinTriforceGFXSettings.set("Enhancements", "ForceTextureFiltering", filtering)

        dolphinTriforceGFXSettings.set("Enhancements", "OutputResampling", system.get_option_str("triforce_resampling", "0"))
