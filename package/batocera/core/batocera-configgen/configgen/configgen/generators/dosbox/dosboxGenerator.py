...
class DosBoxGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        iniSettings.set("cpu", "core", system.get_option("dosbox_cpu_core", "auto"))
        iniSettings.set("cpu", "cputype", system.get_option("dosbox_cpu_cputype", "auto"))
        iniSettings.set("cpu", "cycles", system.get_option("dosbox_cpu_cycles", "auto"))
