...
class Vita3kGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        # Set FXAA
        vita3kymlconfig["enable-fxaa"] = system.get_option_bool("vita3k_fxaa", return_values=("true", "false"))
        # Set VSync
        vita3kymlconfig["v-sync"] = system.get_option_bool("vita3k_vsync", True, return_values=("true", "false"))
        ...
        vita3kymlconfig["enable-linear-filter"] = system.get_option_bool("vita3k_linear", return_values=("true", "false"))
        # Surface Sync
