...
class Vita3kGenerator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        # Set the renderer
        vita3kymlconfig["backend-renderer"] = system.get_option("vita3k_gfxbackend", "OpenGL")
        # Set the resolution multiplier
        vita3kymlconfig["resolution-multiplier"] = system.get_option_int("vita3k_resolution", 1)
        # Set FXAA
        vita3kymlconfig["enable-fxaa"] = system.get_option_bool("vita3k_surface", return_values=("true", "false"))
        # Set VSync
        vita3kymlconfig["v-sync"] = system.get_option_bool("vita3k_surface", True, return_values=("true", "false"))
        # Set the anisotropic filtering
        vita3kymlconfig["anisotropic-filtering"] = system.get_option_int("vita3k_anisotropic", 1)
        # Set the linear filtering option
        vita3kymlconfig["enable-linear-filter"] = system.get_option_bool("vita3k_surface", return_values=("true", "false"))
        # Surface Sync
        vita3kymlconfig["disable-surface-sync"] = system.get_option_bool("vita3k_surface", True, return_values=("true", "false"))
