...
class Fallout1Generator(Generator):
    ...
    def generate(self, system, rom, playersControllers, metadata, guns, wheels, gameResolution):
        ...
        fout1Cfg.set("preferences", "game_difficulty", system.get_option_str("fout1_game_difficulty", "1"))
        fout1Cfg.set("preferences", "combat_difficulty", system.get_option_str("fout1_combat_difficulty", "1"))
        fout1Cfg.set("preferences", "violence_level", system.get_option_str("fout1_violence_level", "2"))
        fout1Cfg.set("preferences", "subtitles", system.get_option_str("fout1_subtitles", "0"))
        fout1Cfg.set("system", "language", system.get_option_str("fout1_language", "english"))
