...
_ControllerSequence: TypeAlias = _ButtonControllerSequence | _ButtonComboControllerSequence | _KeyboardControllerSequence | _BlankControllerSequence
...
_Trigger: TypeAlias = dict[str, bool | float | str]
_Bindings: TypeAlias = list[dict[str, list[_Trigger]]]
