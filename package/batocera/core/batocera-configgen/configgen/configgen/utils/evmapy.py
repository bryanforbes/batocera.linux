...
from ..batoceraPaths import EVMAPY
...
_KeysActions: TypeAlias = list[_KeysAction | _KeysMouseAction]
_KeysConfig: TypeAlias = dict[str, _KeysActions]
    ...
    def __build_merged_keys_file(self) -> Path | None:
        ...
        for file in files_to_merge:
            ...
            for action, value in values.items():
                merged_values[action].extend(value)
