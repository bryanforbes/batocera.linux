...
class TestMameGenerator:
    ...
    def test_get_hotkeys_context(self, snapshot: SnapshotAssertion) -> None:
        ...
        assert MameGenerator().getHotkeysContext() == snapshot

    def test_supports_internal_bezesl(self) -> None:
        from configgen.generators.mame.mameGenerator import MameGenerator

        assert MameGenerator().supportsInternalBezels()
