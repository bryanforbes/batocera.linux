...
""",
        ...
        assert generator.getInGameRatio(mock_system_config, resolution, '') == result
...
""",
    ...
    def test_generate_controllers(
        ...
        controllers[3].real_name = controllers[1].real_name
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                {'dolphin-lightgun-hide-crosshair': '0'},
                {
                    'gun_action': 'z,shake',
                    'gun_start': 'tiltleft',
                    'gun_select': 'a',
            ...
            pytest.param(
                {'dolphin-lightgun-hide-crosshair': '1'},
                {
                    'gun_action': 'z,shake',
                    'gun_start': 'tiltleft',
                    'gun_select': 'a',
