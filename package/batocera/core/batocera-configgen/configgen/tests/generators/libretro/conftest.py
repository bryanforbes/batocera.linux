...
@pytest.fixture(autouse=True)
def get_devices_information(mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
    mock = mocker.patch(
...
@pytest.fixture(autouse=True)
def get_associated_mouse(mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
    mock = mocker.patch(
...
@pytest.fixture
def get_games_metadata(mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
    return mocker.patch(
...
@pytest.fixture
def guns_need_crosses(mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
    return mocker.patch(
        'configgen.controllersConfig.gunsNeedCrosses',
        return_value=getattr(request, 'param', True),
    )


@pytest.fixture
def get_gl_vendor(mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
    return mocker.patch(
...
@pytest.fixture
def get_gl_version(mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
