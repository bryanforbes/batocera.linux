...
class TestLibretroGenerator(GeneratorBaseTest, LibretroBaseMixin):
    ...
    @pytest.fixture
    def video_mode_support_system_rotation(self, mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
    ...
    def test_generate_low_resolution(
        ...
        assert (CONFIGS / 'retroarch' / 'retroarchcustom.cfg').read_text() == snapshot
