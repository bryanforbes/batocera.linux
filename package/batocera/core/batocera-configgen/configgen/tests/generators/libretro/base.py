    ...
    *,
    ...
    def decorator(func: Callable[P, R]) -> Callable[P, R]:
        ...
        @pytest.mark.usefixtures(
            ...
            'controllers_config_guns_borders_size_name',
            'controllers_config_guns_border_ratio_type',
        )
        @wraps(func)
...
class LibretroBaseCoreTest(GeneratorBaseMixin, LibretroBaseMixin):
    ...
    @pytest.fixture
    def controllers_config_guns_need_crosses(self, mocker: MockerFixture, request: pytest.FixtureRequest) -> Mock:
        return mocker.patch(
            'configgen.controllersConfig.gunsNeedCrosses', return_value=getattr(request, 'param', False)
        )

    @pytest.fixture
    def controllers_config_guns_borders_size_name(self, mocker: MockerFixture) -> Mock:
        return mocker.patch('configgen.controllersConfig.gunsBordersSizeName', return_value=None)

    @pytest.fixture
    def controllers_config_guns_border_ratio_type(self, mocker: MockerFixture) -> Mock:
