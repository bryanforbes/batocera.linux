...
class TestSupermodelGenerator(GeneratorBaseTest):
    ...
    def guns_need_crosses(self, mocker: MockerFixture) -> Mock:
        return mocker.patch('configgen.controllersConfig.gunsNeedCrosses', return_value=True)
    ...
    def test_generate_existing(
        self, generator: Generator, fs: FakeFilesystem, mock_system: Emulator, one_player_controllers: ControllerMapping
    ) -> None:
