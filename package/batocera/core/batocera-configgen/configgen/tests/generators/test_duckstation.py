...
class TestDuckstationGenerator:
    @pytest.fixture
...
""",
    ...
    def test_generate_no_bios_dir_raises(
        self, mock_system: Emulator, one_player_controllers: ControllerMapping
    ) -> None:
