...
class TestSdlPopGenerator:
    ...
    def test_generate(
        ...
        assert str(Path('/usr/share/sdlpop/SDLPoP.cfg').resolve()) == str(CONFIGS / 'sdlpop' / 'SDLPoP.cfg')
        assert str(Path('/usr/share/sdlpop/SDLPoP.ini').resolve()) == str(CONFIGS / 'sdlpop' / 'SDLPoP.ini')
        assert str(Path('/usr/share/sdlpop/screenshots').resolve()) == str(SCREENSHOTS / 'sdlpop')
