...
class TestDuckstationLegacyGenerator(GeneratorBaseTest):
    @pytest.fixture
    def generator_cls(self) -> type[DuckstationLegacyGenerator]:
...
""",
    ...
    def test_generate_no_bios_raises(
        ...
        with pytest.raises(BatoceraException, match='^No PSX1 BIOS found$'):
            generator.generate(
                mock_system,
                ROMS / 'psx' / 'rom.chd',
                one_player_controllers,
