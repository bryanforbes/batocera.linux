...
""",
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param({}, {0: {'need_cross': False}}, id='no config, need_cross false'),
            pytest.param({}, {0: {'need_cross': True}}, id='no config, need_cross true'),
            pytest.param(
                {'model2_crossHairs': '1'}, {0: {'need_cross': True}}, id='config crossHairs 1, need_cross true'
            ),
            pytest.param(
                {'model2_crossHairs': '0'}, {0: {'need_cross': True}}, id='config crossHairs 0, need_cross true'
            ),
        ],
    )
