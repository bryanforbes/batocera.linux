...
<inputList>
    ...
    return Controller(
        name='GPIO Controller 2',
        type='joystick',
        guid='15000000010000000200000000010000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        ...
        type='joystick',
        guid='030000004c050000c405000011810000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        ...
        type='joystick',
        guid='030000007e0500000920000011810000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        ...
        type='joystick',
        guid='050000007e050000060300001c3a0000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        name='N64 Controller',
        type='joystick',
        guid='050000007e0500001920000001800000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        name='Nintendo Co., Ltd. N64 Controller',
        type='joystick',
        guid='030000007e0500001920000011810000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        name='8BitDo N64 Modkit',
        type='joystick',
        guid='05000000c82d00006928000000010000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        ...
        type='joystick',
        guid='030000006d04000062c2000011010000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
...
<inputList>
    ...
    return Controller(
        ...
        type='joystick',
        guid='0000000010ba00008ace000000000000',
        player_number=-1,
        index=-1,
        real_name='',
        device_path='',
