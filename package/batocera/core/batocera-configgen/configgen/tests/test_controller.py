...
from configgen.batoceraPaths import BATOCERA_ES_DIR, USER_ES_DIR
...
class TestController:
    ...
    def test_from_element(self, snapshot: SnapshotAssertion) -> None:
...
<inputList>
	<inputConfig type="joystick" deviceName="Generic Xbox pad" deviceGUID="030000005e0400000a0b000005040000">
        ...
        assert Controller.from_element(cast(ET.Element, root.find('./inputConfig'))) == snapshot

    def test_load_all(self, fs: FakeFilesystem, snapshot: SnapshotAssertion) -> None:
        fs.create_file(
...
""",
        ...
        assert Controller.load_all() == snapshot
