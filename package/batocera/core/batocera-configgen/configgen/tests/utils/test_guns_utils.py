...
def test_precalibration_mame(
    fs: FakeFilesystem, emulator: str, core: str | None, target_dir: str | None, source_files: list[StrPath] | None
) -> None:
    ...
    precalibration('mame', emulator, core, ROMS / 'mame' / 'rom.zip')
